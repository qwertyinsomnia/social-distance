...
def parse_args():
    ...
    parser.add_argument('--dir_annotations', default='dataset/WildTrack_dataset/annotations_positions/', 
                        help='directory where the annotations are stored, default: %(default)s')
    parser.add_argument('--dir_frames', default='dataset/WildTrack_dataset/Image_subsets/',
